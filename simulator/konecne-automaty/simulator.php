<!-- 
 ...
 -->
        <link href="simulator/konecne-automaty/style.css" rel="stylesheet" type="text/css" media="screen">
        <script src="simulator/konecne-automaty/raphael.js" type="text/javascript" charset="utf-8"></script>
        <script src="simulator/konecne-automaty/jquery.js" type="text/javascript" charset="utf-8"></script>
        <script src="simulator/konecne-automaty/lang.js" type="text/javascript" charset="utf-8"></script>
        <script src="simulator/konecne-automaty/automata.js" type="text/javascript" charset="utf-8"></script>
